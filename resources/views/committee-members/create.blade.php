            ...
            <form action="{{ route('committee-members.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="member_id" class="w-full border-gray-300 dark:border-gray-600 rounded px-3 py-2 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200">
                        ...
                        @foreach($members as $member)
                            <option value="{{ $member->member_id }}">{{ $member->full_name }} ({{ $member->member_no }})</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4 flex gap-2">
                    <div class="flex-1">
                        ...
                        <input type="date" name="term_start" class="w-full border-gray-300 dark:border-gray-600 rounded px-3 py-2 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200">
                    ...
                    <div class="flex-1">
                        ...
                        <input type="date" name="term_end" class="w-full border-gray-300 dark:border-gray-600 rounded px-3 py-2 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200">
                ...
                <div class="flex justify-end space-x-2">
                    ...
                    <button type="submit" class="px-4 py-2 rounded bg-cyan-600 hover:bg-cyan-700 text-white">Assign Role</button>
                </div>
            </form>
        </div>
    </div>
